...
namespace LambdaExpressionProblem
{
    internal class LambdaSample
    {
        public static void AddRecords(List<Person> ListPersonInCity)
        {
            ...
            ListPersonInCity.Add(new Person("205356876", "Sam", "13 main street newyork", 17));
            ListPersonInCity.Add(new Person("103159376", "Smith", "14 main street newyork", 35));
            ListPersonInCity.Add(new Person("903456254", "Sam", "15 main street newyork", 45));
            ListPersonInCity.Add(new Person("254857243", "John", "52 main street newyork", 55));
            ListPersonInCity.Add(new Person("364587257", "Sue", "16 main street newyork",65));
            ListPersonInCity.Add(new Person("725887258", "Mac", "82 main street newyork", 85));
            ListPersonInCity.Add(new Person("015587256", "Sam", "23 main street newyork", 95));
